...
import { updateOrCreateUserRole } from "@/actions/server/onboarding";
...
export default function RoleSelection({
	...
	const handleContinue = async () => {
		if (selectedRole) {
			...
			try {
				// Update or create the role in the database
				const result = await updateOrCreateUserRole(selectedRole);
