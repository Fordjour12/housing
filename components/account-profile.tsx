...
const USER_DATA = {
  ...
  subscriptionPlan: {
    ...
    features: ["Unlimited listings", "Featured properties", "Analytics dashboard"],
  },
}
...
export default function AccountProfile() {
  ...
  const handleToggleNotification = (category: string, type: "email" | "push", value: boolean) => {
    setUser({
      ...user,
      preferences: {
        ...user.preferences,
  ...
  const handleRemoveFavorite = (id: number) => {
    setUser({
      ...user,
      favoriteListings: user.favoriteListings.filter((listing) => listing.id !== id),
    })
  }
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Switch between renter and landlord views</p>
              </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-1">
                          {isRenter && <Badge variant="secondary">Renter</Badge>}
                          {isLandlord && <Badge variant="secondary">Landlord</Badge>}
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex items-center p-4 border rounded-lg">
                      <div
                        className={`h-10 w-10 rounded-full flex items-center justify-center ${
                          user.verifications.email ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"
                        }`}
                      >
                        {user.verifications.email ? (
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {user.verifications.email ? "Verified" : "Not verified"}
                        </p>
                      </div>
                      {!user.verifications.email && (
                    ...
                    <div className="flex items-center p-4 border rounded-lg">
                      <div
                        className={`h-10 w-10 rounded-full flex items-center justify-center ${
                          user.verifications.phone ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"
                        }`}
                      >
                        {user.verifications.phone ? (
                          <CheckCircle className="h-5 w-5" />
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {user.verifications.phone ? "Verified" : "Not verified"}
                        </p>
                      </div>
                      {!user.verifications.phone && (
                        <Button variant="outline" size="sm" className="ml-auto">
                    ...
                    <div className="flex items-center p-4 border rounded-lg">
                      <div
                        className={`h-10 w-10 rounded-full flex items-center justify-center ${
                          user.verifications.identity ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"
                        }`}
                      >
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {user.verifications.identity ? "Verified" : "Not verified"}
                        </p>
                      </div>
                      {!user.verifications.identity && (
                        <Button variant="outline" size="sm" className="ml-auto">
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    Verified accounts receive priority in rental applications and build trust with landlords.
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <TabsContent value="saved" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Get notified when new properties match your search criteria</CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div key={search.id} className="border rounded-lg p-4">
                        <div className="flex justify-between items-start">
                          <div>
                            <h3 className="font-medium flex items-center">
                              ...
                              {search.newListings > 0 && (
                                <Badge className="ml-2 bg-green-500">{search.newListings} new</Badge>
                              )}
                            </h3>
                          ...
                          <div className="flex gap-2">
                            <Button variant="outline" size="sm" asChild>
                              <Link href={`/listings?search=${search.id}`}>View Results</Link>
                            </Button>
                            <Button
                              variant="ghost"
                              size="sm"
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium">{search.priceRange}</p>
                          </div>
                          <div>
                            <p className="text-xs text-muted-foreground">Bedrooms</p>
                            <p className="text-sm font-medium">{search.bedrooms}</p>
                          </div>
                          <div>
                            <p className="text-xs text-muted-foreground">Last Updated</p>
                            <p className="text-sm font-medium">{new Date(search.lastNotified).toLocaleDateString()}</p>
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              <CardContent>
                {user.favoriteListings.length > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <h3 className="text-lg font-medium">No favorite listings yet</h3>
                    <p className="text-muted-foreground mt-1 mb-4">Save properties you like to compare them later</p>
                    <Button asChild>
              ...
              <CardContent>
                {user.rentalApplications.length > 0 ? (
                      ...
                      <div key={application.id} className="border rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium">{application.nextSteps}</p>
                          </div>
                        </div>
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-muted-foreground mt-1 mb-4">Apply for properties you're interested in renting</p>
                    <Button asChild>
                      <Link href="/listings">Browse Listings</Link>
                    </Button>
                  </div>
          ...
          <TabsContent value="listings" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your rental property listings</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                  <div>
                    <h3 className="text-lg font-medium">Your Listings</h3>
                    <p className="text-sm text-muted-foreground">You have 5 total listings (3 active, 2 inactive)</p>
                  </div>
                  <Button asChild>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="border rounded-lg p-4 flex flex-col">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Currently visible to renters</p>
                    <Button variant="outline" size="sm" className="mt-auto" asChild>
                      <Link href="/landlord/listings?tab=active">View Active</Link>
                    </Button>
                  </div>
                  ...
                  <div className="border rounded-lg p-4 flex flex-col">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Hidden from search results</p>
                    <Button variant="outline" size="sm" className="mt-auto" asChild>
                      <Link href="/landlord/listings?tab=inactive">View Inactive</Link>
                    </Button>
                  </div>
                  ...
                  <div className="border rounded-lg p-4 flex flex-col">
                    ...
                    <Button className="mt-auto" asChild>
                      <Link href="/landlord/listings/create">Create Listing</Link>
                    </Button>
                  </div>
                </div>
                ...
                <div className="mt-6 border-t pt-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm">
                          <span className="font-medium">New application</span> for Cozy 2 Bedroom Apartment
                        </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm">
                          <span className="font-medium">15 new views</span> on Modern 3 Bedroom House
                        </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm">
                          <span className="font-medium">New message</span> about Downtown Studio Apartment
                        </p>
                ...
                {user.subscriptionPlan && (
                  <div className="border rounded-lg p-6">
                    <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                      <div>
                        <h3 className="text-lg font-medium">{user.subscriptionPlan.name}</h3>
                        <p className="text-sm text-muted-foreground">
                          ${user.subscriptionPlan.price}/{user.subscriptionPlan.billingCycle}
                        </p>
                      </div>
                      <div className="flex gap-2">
                    ...
                    <div className="mt-4">
                      <p className="text-sm text-muted-foreground">
                        Next billing date: {new Date(user.subscriptionPlan.nextBilling).toLocaleDateString()}
                      </p>
                    </div>
                    <div className="mt-4">
                      <h4 className="text-sm font-medium mb-2">Plan Features</h4>
                      <ul className="space-y-1">
                        {user.subscriptionPlan.features.map((feature, index) => (
                    ...
                    <table className="w-full">
                      ...
                      <tbody className="divide-y">
                        <tr>
                          ...
                          <td className="p-3 text-sm">Landlord Pro Subscription</td>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        checked={user.preferences.emailNotifications.newListings}
                        onCheckedChange={(checked) => handleToggleNotification("newListings", "email", checked)}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Receive emails when there are updates to your rental applications
                        </p>
                      </div>
                      <Switch
                        id="email-application-updates"
                        checked={user.preferences.emailNotifications.applicationUpdates}
                        onCheckedChange={(checked) => handleToggleNotification("applicationUpdates", "email", checked)}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label htmlFor="email-message-alerts">Message Alerts</Label>
                        <p className="text-sm text-muted-foreground">Receive emails when you get new messages</p>
                      </div>
                      <Switch
                        id="email-message-alerts"
                        checked={user.preferences.emailNotifications.messageAlerts}
                        onCheckedChange={(checked) => handleToggleNotification("messageAlerts", "email", checked)}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Receive emails about promotions, new features, and platform updates
                        </p>
                      </div>
                      <Switch
                        id="email-promotions"
                        checked={user.preferences.emailNotifications.promotions}
                        onCheckedChange={(checked) => handleToggleNotification("promotions", "email", checked)}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Receive push notifications when new properties match your saved searches
                        </p>
                      </div>
                      <Switch
                        id="push-new-listings"
                        checked={user.preferences.pushNotifications.newListings}
                        onCheckedChange={(checked) => handleToggleNotification("newListings", "push", checked)}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Receive push notifications when there are updates to your rental applications
                        </p>
                      </div>
                      <Switch
                        id="push-application-updates"
                        checked={user.preferences.pushNotifications.applicationUpdates}
                        onCheckedChange={(checked) => handleToggleNotification("applicationUpdates", "push", checked)}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label htmlFor="push-message-alerts">Message Alerts</Label>
                        <p className="text-sm text-muted-foreground">
                      ...
                      <Switch
                        ...
                        checked={user.preferences.pushNotifications.messageAlerts}
                        onCheckedChange={(checked) => handleToggleNotification("messageAlerts", "push", checked)}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label htmlFor="push-promotions">Promotions & Updates</Label>
                        <p className="text-sm text-muted-foreground">
                          Receive push notifications about promotions, new features, and platform updates
                        </p>
                      </div>
                      <Switch
                        id="push-promotions"
                        checked={user.preferences.pushNotifications.promotions}
                        onCheckedChange={(checked) => handleToggleNotification("promotions", "push", checked)}
                      />
                    </div>
                  </div>
                </div>
...
function BedDouble({ className }: { className?: string }) {
  return (
    <svg
...
function Bath({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
