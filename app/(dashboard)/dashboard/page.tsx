				...
				<Tabs defaultValue="overview" className="space-y-4">
						...
						<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
							<Card className="col-span-4">
								<CardHeader>
									...
									<CardDescription>
										Key details from your active lease agreement
									</CardDescription>
								</CardHeader>
							...
							<Card className="col-span-3">
								...
								<CardContent>{/* <UpcomingReminders /> */}</CardContent>
							</Card>
						</div>
					</TabsContent>
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between">
								<div>
									...
									<CardDescription>
										Manage your lease renewal process
									</CardDescription>
								</div>
									...
									<div className="p-4">
										<div className="grid gap-4 md:grid-cols-3">
											...
											<div className="space-y-1">
												...
												<p className="text-xs text-muted-foreground">
													Renewal period begins in 185 days
												</p>
											</div>
										</div>
									</div>
					...
					<TabsContent value="documents" className="space-y-4">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									All your lease agreements in one secure place
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-4">
								<div className="rounded-md border">
					...
					<TabsContent value="maintenance" className="space-y-4">
						<Card>
							...
							<CardContent>{/* <MaintenanceRequestsList /> */}</CardContent>
						</Card>
					</TabsContent>
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between">
								<div>
									...
									<CardDescription>
										Document and track the condition of your rental property
									</CardDescription>
								</div>
							</CardHeader>
							<CardContent className="space-y-4">
											...
											<div className="absolute inset-0 flex items-center justify-center">
												...
												<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/20 flex flex-col items-center justify-center text-white p-4">
													...
													<p className="text-sm text-center">
														Document the condition of your property at the start
														of your lease
													</p>
												</div>
											</div>
										...
										<div className="aspect-video bg-muted relative">
											<div className="absolute inset-0 flex items-center justify-center">
												...
												<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/20 flex flex-col items-center justify-center text-white p-4">
													...
													<p className="text-sm text-center">
														Document the condition of your property at the end
														of your lease
													</p>
												</div>
											</div>
								...
								<div className="rounded-md border">
									<div className="p-4 bg-muted/50">
										...
										<p className="text-sm text-muted-foreground">
											All photos and videos documenting your property's
											condition
										</p>
									</div>
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between">
								<div>
									...
									<CardDescription>
										Secure messaging with your landlord and property management
									</CardDescription>
								</div>
								...
								<div className="rounded-md border">
									...
									<div className="p-4">
										<p className="text-sm text-muted-foreground mb-4">
											Access resources to help resolve disputes and understand
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between">
								<div>
									...
									<CardDescription>
										Track and manage your security deposit
									</CardDescription>
								</div>
								...
								<div className="space-y-4">
									...
									<div className="flex items-center justify-between rounded-lg border p-4">
										<div className="space-y-0.5">
											...
											<div className="text-sm text-muted-foreground">
												Notify 60, 30, and 14 days before expiration
											</div>
										</div>
										<Button variant="outline">Edit</Button>
									</div>
